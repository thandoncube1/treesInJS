    ...
    lookup(value) {
        ...
        while (currentNode) {
            if (value < currentNode.value) {
                ...
                console.log(`Lookup: ${JSON.stringify(currentNode)}`);
                return currentNode;
            }
        }
        return false;
        ...
        while (currentNode) {
            if (value < currentNode.value) {
                ...
                // Option 2: Right child which doesn't have a left child
                    ...
                    if (parentNode === null) {
                        ...
                        if (currentNode.value < parentNode.value) {
                            ...
                            // If parent < current, make the child a right child of the parent
                        } else if (currentNode.value > parentNode.value) {
                ...
                // Option 3: Right child that has a left child
                    ...
                    // Parent's left subtree is now lefftmost's right subtree
